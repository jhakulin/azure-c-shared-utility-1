...
static void enter_open_error_state(TLS_IO_INSTANCE* tls_io_instance)
{
    ...
    on_open_complete(on_open_complete_context, IO_OPEN_ERROR, NULL);
}
    ...
    else
    {
        ...
        else
        {
            ...
            if (is_an_opening_state(tls_io_instance->tlsio_state))
            {
                ...
                tls_io_instance->on_open_complete(tls_io_instance->on_open_complete_context, IO_OPEN_CANCELLED, NULL);
            }
...
static void dowork_poll_open_ssl(TLS_IO_INSTANCE* tls_io_instance)
{
    ...
    {   
        ...
        tls_io_instance->on_open_complete(tls_io_instance->on_open_complete_context, IO_OPEN_OK, NULL);
    }
    else
    {
